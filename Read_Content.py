...
def read_slide_content(slide, engine):
...
# Reduce the speed of audio reading
engine.setProperty('rate', 125)  # Adjust this value as needed, lower values mean slower speech

for i, slide in enumerate(prs.slides):
    read_slide_content(slide, engine)
    # Delay for the duration of the audio playback
    time.sleep(len(slide.placeholders[1].text) / 100)  # Adjust the factor to control the speed of audio reading
